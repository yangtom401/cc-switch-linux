...
pub use mcp::{
    import_from_claude, import_from_codex, import_from_gemini, import_from_opencode,
    remove_server_from_claude, remove_server_from_codex, remove_server_from_gemini,
    remove_server_from_opencode, sync_enabled_to_claude, sync_enabled_to_codex,
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            if let Err(e) = app_state.update_config(|config| {
                ...
                config.ensure_app(&app_config::AppType::GrokBuild);
                config.ensure_app(&app_config::AppType::Hermes);
                Ok(())
            }) {
