...
import type { OpenClawDefaultModel } from "../lib/api/openclaw";
import type { OpenClawProviderConfigPreset as OpenClawProviderConfig } from "./openclawProviderPresets";
 ...
 */
export const upstreamOpenClawProviderPresetsV315: OpenClawProviderPreset[] = [
  {
    name: "Shengsuanyun",
