...
export const claudeDesktopProviderPresets: ClaudeDesktopProviderPreset[] = [
  {
    ...
    settingsConfig: presetConfig("https://router.shengsuanyun.com/api"),
    mode: "direct",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://generativelanguage.googleapis.com"),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.githubcopilot.com"),
    mode: "proxy",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://chatgpt.com/backend-api/codex"),
    mode: "proxy",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.deepseek.com/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "deepseek-v4-pro",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://open.bigmodel.cn/api/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.z.ai/api/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes("glm-5", "glm-5", "glm-5"),
    icon: "zhipu",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.moonshot.cn/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.kimi.com/coding/"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    icon: "kimi",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.stepfun.com/step_plan"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "step-3.5-flash-2603",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.stepfun.ai/step_plan"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "step-3.5-flash-2603",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api-inference.modelscope.cn"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "ZhipuAI/GLM-5",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.longcat.chat/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "LongCat-Flash-Chat",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.minimaxi.com/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.minimax.io/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes("MiniMax-M2.7", "MiniMax-M2.7", "MiniMax-M2.7"),
    isPartner: true,
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.tbox.cn/api/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://aihubmix.com"),
    apiKeyField: "ANTHROPIC_API_KEY",
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.siliconflow.cn"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.siliconflow.com"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://www.dmxapi.cn"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://www.packyapi.com"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    endpointCandidates: [
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.cubence.com"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    endpointCandidates: [
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.aigocode.com"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://www.right.codes/claude"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    isPartner: true,
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.aicodemirror.com/api/claudecode"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    endpointCandidates: [
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.aicoding.sh"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://cn.crazyrouter.com"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://node-hk.sssaicode.com/api"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    endpointCandidates: [
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://cp.compshare.cn"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://www.micuapi.ai"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.ctok.ai"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    isPartner: true,
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://e-flowcode.cc"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://vibecodingapi.ai"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    isPartner: true,
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://openrouter.ai/api"),
    mode: "proxy",
    apiFormat: "anthropic",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.therouter.ai"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: mappedRoutes(
      "anthropic/claude-sonnet-4.6",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.novita.ai/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
    modelRoutes: brandedRoutes(
      "zai-org/glm-5",
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://api.lemondata.cc"),
    apiKeyField: "ANTHROPIC_API_KEY",
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://integrate.api.nvidia.com"),
    mode: "proxy",
    apiFormat: "openai_chat",
    modelRoutes: brandedRoutes(
  ...
  },
  {
    ...
    settingsConfig: presetConfig("https://cc-api.pipellm.ai"),
    mode: "direct",
    apiFormat: "anthropic",
    modelRoutes: passthroughRoutes(),
    icon: "pipellm",
  },
  {
    ...
    settingsConfig: presetConfig("https://api.xiaomimimo.com/anthropic"),
    mode: "proxy",
    apiFormat: "anthropic",
